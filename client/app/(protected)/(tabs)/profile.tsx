...
const SearchComponent = ({ item }: { item: any }) => (
	<View style={styles.bookmarkCard}>
		...
		<Pressable style={styles.bookmarkAction}>
			<AntDesign
				name="heart"
				size={16}
				color="#EF4444"
...
export default function Profile() {
	...
	const [bookmark, setBookmark] = useState<any>([
		{ Tempat: { name: "Museum Tsunami", location: "Banda Aceh" } },
		{ Tempat: { name: "Pantai Lampuuk", location: "Banda Aceh" } },
		{ Tempat: { name: "Masjid Raya", location: "Banda Aceh" } },
	]);
